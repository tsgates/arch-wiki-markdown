...
(i.e. "/" appears as a square), try uninstalling font-mathematica.
...
easiest method to overcome this is to make a symlink from /usr/lib64 to
...
Internet Connectivity > Proxy Settings). This bug has been reported to
Wolfram.

> Mathematica 9

Install mathematica from the AUR. The Mathematica_9.0.1_LINUX.sh
...
Retrieved from
"https://wiki.archlinux.org/index.php?title=Mathematica&oldid=290270"

Category:

-   Mathematics and science

-   This page was last modified on 24 December 2013, at 17:32.
